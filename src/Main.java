...
public class Main {
    ...
    private static int delay = 0;                                     // Ändra delay i millisekunder
    ...
    private static boolean checkSunkenShips = false;                    // Slå av/på sökning efter sjunkna skepp i närområdet
